...
// }
const generateEngineer = function (newEngineer) {
  return `
  <div class="card-header bg-primary text-white fs-4">
...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item">GitHub (if applicable): ${engineer.github}</li>
</ul>
</div>
  `;
}
// card for Manager
const generateManager = function (newManager) {
  return `
  <div class="card-header bg-primary text-white fs-4">
  ...
  <li class="list-group-item">Number: ${newManager.officeNumber}</li>
  </ul>
  </div>
  `
}
// card for intern
const generateIntern = function (newIntern) {
  return `
  <div class="card-header bg-primary text-white fs-4">
  ${newIntern.employeeName}
  </div>
  <div class="bg-primary text-white fs-5 ">
  <span class="oi oi-headphones m-2"></span>
  Intern
